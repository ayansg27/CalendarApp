...
<body>
	...
	<div class="content">
		<p>
			<% 
             	String message = (String)request.getAttribute(com.planeasy.GlobalConstants.MESSAGE);		
			%>
			<%= message%>
			</p>
<!-- 		<p>Registration link sent to your mail successfully. <br> -->
<!-- 		Please verify your email.</p> -->
	</div>
<!-- 	<div class="content1"> -->
<!-- 		<span> -->
<!-- 			Go to <a href="login.jsp" style="color:orange"><b><i>login</i></b></a> page. -->
<!-- 		</span> -->
<!-- 	</div> -->
</body>
<footer>
